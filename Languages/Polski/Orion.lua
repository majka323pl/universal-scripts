...
if not okOrion or not OrionLib then
    warn("Nie dało się wczytać Oriona!")
    return
end
...
-- Orion Window & Tabs (original UI preserved)
...
HomeTab:AddButton({Name = "Anty-Fling", Callback = function() safeLoadURL("https://raw.githubusercontent.com/majka323pl/universal-scripts/refs/heads/main/anty-fling") end})
