...
local function openEditModal()
    if not ExecutorGui then return end
    if not selectedFile then rNotify("Edit","Select a file from the list.",3); return end
...
local function openRenameModal()
    if not ExecutorGui then return end
    if not selectedFile then rNotify("Rename","Select a file from the list.",3); return end
    local old = selectedFile
    local overlay, modal = createModal(ExecutorGui)
...
local function openDeleteModal()
    if not ExecutorGui then return end
    if not selectedFile then rNotify("Delete","Select a file from the list.",3); return end
...
local function createExecutor()
    ...
    btnLoad.MouseButton1Click:Connect(function()
        if not selectedFile then rNotify("Load","Select a file from the list.",3); return end
